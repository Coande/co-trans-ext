if (
  this.JSON &&
  this.JSON.stringify.toString().indexOf('[native code]') !== -1
) {
    ...
    parseData: (function() {
      ...
      return function(d, e) {
        ...
        if (!!d && !c[d]) {
          a.log(
            '[Error]',
            "Function parseData() dosen't support this type:",
            d
          );
          return e;
        }
...
(function(a) {
  ...
  b.prototype = {
        ...
        var j = {
          transferStationReady: function() {
            i(function(m) {
              ...
              delete m.callback;
              c.postMessage(JSONDAO.stringify(m), f);
              return e;
            });
          },
          dataBack: function(n) {
    ...
    createJTRAssist: function(h, e) {
      var k = this;
      var d = '//fanyi.youdao.com/web2/JTRAssist.swf?' + +new Date();
      var j = function() {
        if (!!a.query('#' + h)) {
          return;
        }
...
(function(a) {
  ...
  TR.isInclude = function(b) {
    return !(
      ...
      b.tagName === 'STYLE' ||
      b.tagName === 'PRE' ||
      // svg 元素的 className 属性是一个 SVGAnimatedString 对象，没有 indexOf 方法
      (b.className &&
        b.className.indexOf &&
        b.className.indexOf('OUTFOX_JTR_') !== -1)
    );
  };
  a.TR = TR;
})(J);
...
(function(h) {
  ...
  var j = function(k) {
    return (
      `<object 
        ...
        <param 
          name="movie" 
          value="//cidian.youdao.com/chromeplus/voice.swf"
          />
        <param 
          name="loop" 
          value="false"
        ...
        <embed 
          wmode="transparent" 
          play="false" 
          src="//cidian.youdao.com/chromeplus/voice.swf" 
          loop="false" 
          menu="false"
          quality="high"
          bgcolor="#ffffff"
  ...
  a.initConnection = function(k) {
    ...
    if (
      ...
      window.chrome.extension.sendRequest
    ) {
      n = {
        request: function(p, q) {
          window.chrome.extension.sendRequest(p, function(r) {
            if (r) {
  ...
  a.processXmlTransData = function(r) {
    var l = (
      ...
      m = h.trim(l);
    if (
      (e.isContainChinese(m) ||
        e.isContainJapanese(m) ||
        e.isContainKoera(m)) &&
      m.length > 15
    ) {
      m = m.substring(0, 8) + ' ...';
  ...
  a.processXmlDictData = function(D) {
    ...
    if ((l = D.getElementsByTagName('web-translation')) && l.length > 0) {
      for (w = 0; w < l.length - 1; w++) {
        z.push({
          ...
          value: l[w]
            .getElementsByTagName('trans')[0]
            .getElementsByTagName('value')[0].firstChild.nodeValue
        });
      }
    }
    var B =
        '//dict.youdao.com/search?q=' +
      ...
      m = '',
      u = null,
      C = '//www.youdao.com/search?q={title}&keyfrom=fanyi.jtr',
      s = '';
    s =
    ...
    if (
      (e.isContainChinese(E) ||
        e.isContainJapanese(E) ||
        e.isContainKoera(E)) &&
      E.length > 15
    ) {
      E = E.substring(0, 10) + '...';
    ...
    if (q.length + z.length > 0 && v) {
      A =
        ...
        j(
          '//dict.youdao.com/speech?audio=' + v,
          'test',
          'CLICK',
          'dictcn_speech'
        ) +
  ...
  b.prototype = {
    ...
    to: function(e, d) {
      ...
      tempFunc = function() {
        ...
        var g =
          c.container.clientWidth - c.controller.clientWidth - 2 * c.borderFix;
        pos = (e / c.range) * g;
  ...
  b.prototype = {
    ...
    _getAllArticle: function() {
      ...
      for (var d = 0, h = f.length > 100 ? 100 : f.length; d < h; d++) {
        var g = f[d];
        if (
          this._checkTagName(g) &&
          this._checkSize(g) &&
          this._checkVisibility(g)
        ) {
          e[e.length] = new c(g);
        }
      }
...
(function(a) {
  ...
  a.TR.UI.prototype = {
          ...
          if (this.mode === 'TRANS') {
            ...
            if (e !== 0) {
              ...
              this.statusElem.innerHTML =
                '共注释<span class="OUTFOX_BAR_TOTAL_NUM">' +
                e +
                '</span>个难词';
            } else {
    ...
    initFrame: function(f, i) {
      ...
      function g(k) {
        k.innerHTML =
          '<iframe id="OUTFOX_JTR_BAR" src="" style="display:none;"></iframe>';
      ...
      this.transTipHandler = function(j) {
        ...
        e = setTimeout(function() {
          ...
          if (a.hasClass(i, 'OUTFOX_JTR_TRANS_NODE')) {
            ...
            f.positionElementInViewPort({
              target: i,
              tip: f.transTipElem.elem
            });
    ...
    resetTransTipElem: function(d, f, e) {
      ...
      a.removeClass(
        this.transTipElem.bottom,
        'OUTFOX_JTR_TRANSTIP_ADVISE_THANK_TIP'
      );
...
(function(d) {
  var f = '//fanyi.youdao.com/web2';
  // 下面这个必须定义，否则无法翻译
  var g = 'https://fanyi.youdao.com';
  var h = '/web2/conn.html';
  var c = f + '/index.do';
  var a = g + '/jtr';
  var e = f + '/rl.do';
  var b = f + '/styles/all-packed.css';
