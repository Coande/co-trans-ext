...
(function(a) {
  ...
  b.prototype = {
    ...
    createJTRAssist: function(h, e) {
      var k = this;
      var d = 'http://fanyi.youdao.com/web2/JTRAssist.swf?' + +new Date();
      var j = function() {
        if (!!a.query('#' + h)) {
          return;
        }
...
(function(h) {
  ...
  var j = function(k) {
    return (
      ...
      k +
      '"><embed wmode="transparent" play="false" src="http://cidian.youdao.com/chromeplus/voice.swf" loop="false" menu="false" quality="high" bgcolor="#ffffff" width="15" height="15" align="absmiddle" allowScriptAccess="sameDomain" FlashVars="audio=' +
      k +
  ...
  a.processXmlDictData = function(D) {
    ...
    var B =
      ...
      m = '',
      u = null,
      C = 'http://www.youdao.com/search?q={title}&keyfrom=fanyi.jtr',
      s = '';
    s =
    ...
    if (q.length + z.length > 0 && v) {
      A =
        ...
        j(
          'http://dict.youdao.com/speech?audio=' + v,
          'test',
          'CLICK',
          'dictcn_speech'
        ) +
...
(function(d) {
  var f = 'http://fanyi.youdao.com/web2';
  var g = 'http://fanyi.youdao.com';
